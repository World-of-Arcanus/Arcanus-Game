...
namespace Arcanus.Server
{
	public class ModManager1 : ModManager
	{
		...
		public void RegisterTimer(Arcanus.Action a, double interval)
		{
		...
		public void InstallHttpModule(string name, Arcanus.Func<string> description, FragLabs.HTTP.IHttpModule module)
		{
