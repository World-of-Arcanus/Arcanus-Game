namespace Arcanus.Mods
{
	...
	public class CoreCrafting : IMod
	{
		...
		public void Start(ModManager m)
		{
			...
			m.AddCraftingRecipe2("RailTrack", 2, "OakWood", 1, "IronBlock", 1);
			m.AddCraftingRecipe2("RailTrack", 2, "BirchWood", 1, "IronBlock", 1);
			m.AddCraftingRecipe2("RailTrack", 2, "SpruceWood", 1, "IronBlock", 1);
			m.AddCraftingRecipe2("RailJunction", 1, "OakWood", 2, "IronBlock", 2);
			m.AddCraftingRecipe2("RailJunction", 1, "BirchWood", 2, "IronBlock", 2);
			m.AddCraftingRecipe2("RailJunction", 1, "SpruceWood", 2, "IronBlock", 2);
