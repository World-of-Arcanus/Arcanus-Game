namespace Arcanus.Mods
{
	...
	public class CoreCrafting : IMod
	{
		...
		public void Start(ModManager m)
		{
			...
			m.AddCraftingRecipe2("Rail1", 4, "OakWood", 1, "IronBlock", 1);
			m.AddCraftingRecipe2("Rail1", 4, "BirchWood", 1, "IronBlock", 1);
			m.AddCraftingRecipe2("Rail1", 4, "SpruceWood", 1, "IronBlock", 1);
			...
			m.AddCraftingRecipe2("Rail8", 2, "OakWood", 1, "IronBlock", 1);
			m.AddCraftingRecipe2("Rail8", 2, "BirchWood", 1, "IronBlock", 1);
			m.AddCraftingRecipe2("Rail8", 2, "SpruceWood", 1, "IronBlock", 1);
			m.AddCraftingRecipe2("Rail16", 2, "OakWood", 1, "IronBlock", 1);
			m.AddCraftingRecipe2("Rail16", 2, "BirchWood", 1, "IronBlock", 1);
			m.AddCraftingRecipe2("Rail16", 2, "SpruceWood", 1, "IronBlock", 1);
			m.AddCraftingRecipe2("Rail32", 2, "OakWood", 1, "IronBlock", 1);
			m.AddCraftingRecipe2("Rail32", 2, "BirchWood", 1, "IronBlock", 1);
			m.AddCraftingRecipe2("Rail32", 2, "SpruceWood", 1, "IronBlock", 1);
