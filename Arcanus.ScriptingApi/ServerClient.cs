...
namespace Arcanus
{
	[XmlRoot(ElementName = "ArcanusServerClient")]
	...
	public class ServerClientMisc
	{
		...
		public static List<Group> getDefaultGroups()
		{
			...
			// default guest group
			Arcanus.Group guest = new Arcanus.Group();
			guest.Name = "Guest";
			guest.Level = 0;
			...
			Arcanus.Group builder = new Arcanus.Group();
			...
			Arcanus.Group moderator = new Arcanus.Group();
			...
			// default admin group
			Arcanus.Group admin = new Arcanus.Group();
			admin.Name = "Admin";
			admin.Level = 3;
